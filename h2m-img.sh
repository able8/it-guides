...
BookUrl="http://cw.hubwiz.com/card/c/55d301543ad79a1b05dcc4e2/1/1/1/"  #Node.js 入门
...
do
    ...
    sed -E 's/<h1 id[^>]*>/### /g;s/<\/h1>/∑/g;s/<h2 id[^>]*>/#### /g;s/<\/h2>/∑/g;s/<h3 id[^>]*>/##### /g;s/<\/h3>/∑/g;s/<h4 id[^>]*>/##### /g;s/<\/h4>/∑/g;s/<hr>/-----------------/g;s/<strong>/**/g;s/<\/strong>/**/g;s/<em>/*/g;s/<\/em>/*/g;s/<p>//g;s/<pre><code>/```javascript∑/g;s/<\/code><\/pre>/```∑∑/g;s/<li>/- /g;s/<\/li>//g;s/<ul>/∑/g;s/<\/ul>/∑/g'          |\
